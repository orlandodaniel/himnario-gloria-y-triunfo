...
const Home = () => {
  ...
  const [filtro, setFiltro] = useState<"todos" | "favoritos" | "recientes">("todos");
            ...
            {visibles.map((h) => (
              ...
              >
                <div 
                  ...
                  style={{ backgroundColor: 'var(--bg-primary)', color: 'var(--text-main)', border: '1px solid rgba(37, 99, 235, 0.2)' }}
                >
                  {h.numero}
                </div>
